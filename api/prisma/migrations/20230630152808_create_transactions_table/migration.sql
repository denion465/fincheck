...
-- AddForeignKey
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_gategory_id_fkey" FOREIGN KEY ("gategory_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
